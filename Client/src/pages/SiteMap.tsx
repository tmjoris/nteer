...
{ key: "al_tawoon_youth_korogocho", location:{lat: -1.2513779803302305, lng: 36.89112782644024}, name:"Al-Tawoon Islamic Youth Group", cause:"Community", capacity:10, current:0, impactScore:85 },
{ key: "ananda_marga_academy_huruma", location:{lat: -1.2722937796570462, lng: 36.75420329630453}, name:"Ananda Marga Academy Huruma", cause:"Education", capacity:10, current:0, impactScore:88 },
{ key: "brook_school_deaf_kamiti", location:{lat: -1.209222802074535, lng: 36.89838278096287}, name:"Brook School for the Deaf & Autistic Kamiti Road", cause:"Education", capacity:15, current:0, impactScore:95 },
{ key: "baraka_al_ibrahim_kibera", location:{lat:-1.3146827159107064, lng: 36.78502003196789}, name:"Baraka Za Ibrahim Children’s Center Kibera", cause:"Community", capacity:10, current:0, impactScore:87 },
{ key: "cherish_watoto_learning_centre", location:{lat: -1.2722937796570462, lng: 36.75420329630453}, name:"Cherish Watoto Kenya Learning Centre", cause:"Education", capacity:10, current:0, impactScore:90 },
{ key: "christs_victory_center_githurai", location:{lat: -1.2090619285117354, lng: 36.93263339445683}, name:"Christ's Victory Center Kimbo Githurai", cause:"Community", capacity:10, current:0, impactScore:85 }
{ key: "community_progressive_focus_embakasi", location:{lat: -1.2515114418261875, lng: 36.94321237911563}, name:"Community Progressive Focus Centre", cause:"Community", capacity:10, current:0, impactScore:82 },
{ key: "dream_centre_home_of_hope", location:{lat: -1.2920849319075773, lng: 36.90275044691993}, name:"Dream Centre Baby Rescue and Care", cause:"Children", capacity:10, current:0, impactScore:93 },
{ key: "dagoretti_hidden_talent", location:{lat: -1.2977493935733377, lng: 36.74987346359377}, name:"Dagoretti Corner Child Care Program", cause:"Education", capacity:10, current:0, impactScore:88 },
{ key: "grapes_yard_korogocho", location:{lat: -1.2724653963437262, lng: 36.95769633678646}, name:"Grapes Yard Organization Korogocho", cause:"Community", capacity:10, current:0, impactScore:86 },
{ key: "hope_house_babies_home", location:{lat: -1.2680080366096689, lng: 36.73831219441074}, name:"Hope House Babies Home", cause:"Children", capacity:10, current:0, impactScore:93 },
{ key: "imani_children_home_kayole", location:{lat: -1.2604358211371354, lng: 36.924826530436654}, name:"Imani Children’s Home Kayole", cause:"Children", capacity:10, current:0, impactScore:89 },
{ key: "nest_children_home_runda", location:{lat: -1.0926009045437686, lng: 36.659452192343146}, name:"The Nest Children’s Home Runda", cause:"Children", capacity:10, current:0, impactScore:95 },
{ key: "salvation_army_kabete_home", location:{lat: -1.2658928005890093, lng: 36.76512602144511}, name:"Salvation Army Kabete Children’s Home", cause:"Children", capacity:10, current:0, impactScore:90 },
{ key: "jirani_education_centre_korogocho", location:{lat: -1.2457493990385187, lng: 36.89719539630452}, name:"Jirani Education Centre Korogocho", cause:"Education", capacity:10, current:0, impactScore:88 },
{ key: "kabete_rehabilitation_center", location:{lat: -1.238707655841928, lng: 36.731315995742285}, name:"Kabete Rehabilitation Center", cause:"Health", capacity:10, current:0, impactScore:90 },
{ key: "kangemi_health_centre", location:{lat: -1.2668917958173946, lng: 36.74922202329258}, name:"Kangemi Health Centre", cause:"Health", capacity:10, current:0, impactScore:88 },
{ key: "kirigiti_girls_rehabilitation", location:{lat: -1.172165060639376, lng: 36.84723442329194}, name:"Kirigiti Girls Rehabilitation Center", cause:"Community", capacity:10, current:0, impactScore:89 },
{ key: "kwetu_home_of_peace_madaraka", location:{lat:-1.3088951779477365, lng: 36.811234594457446}, name:"Kwetu Home of Peace Madaraka", cause:"Children", capacity:10, current:0, impactScore:91 },
{ key: "kenya_women_children_wellness", location:{lat: -1.2060034637613832, lng: 36.88240586562139}, name:"Kenya Women and Children’s Wellness Centre", cause:"Health", capacity:10, current:0, impactScore:92 },
{ key: "lower_kabete_dispensary", location:{lat: -1.2395503733507862, lng: 36.7459213147937}, name:"Lower Kabete Dispensary", cause:"Health", capacity:10, current:0, impactScore:88 },
{ key: "mama_fatuma_children_home", location:{lat: -1.2670090268875722, lng: 36.8478446656218}, name:"Mama Fatuma Children’s Home", cause:"Children", capacity:10, current:0, impactScore:90 },
{ key: "mama_fauzia_children_home", location:{lat: -1.2188175649670852, lng: 36.9142986521276}, name:"Mama Fauzia Children’s Home", cause:"Children", capacity:10, current:0, impactScore:89 },
{ key: "mary_immaculate_rehab_center", location:{lat: -1.2111683517878724, lng: 36.896075560349615}, name:"Mary Immaculate Rehab Center", cause:"Health", capacity:10, current:0, impactScore:90 },
...
{ key: "mathare_north_health_centre", location:{lat: -1.2558957998163633, lng: 36.865562436786426}, name:"Mathare North Health Centre", cause:"Health", capacity:10, current:0, impactScore:87 },
{ key: "mji_wa_huruma_runda", location:{lat: -1.2250776447083183, lng: 36.827504465621494}, name:"Mji-Wa-Huruma Dispensary Runda", cause:"Health", capacity:10, current:0, impactScore:89 },
{ key: "msamaria_mwema_children_home", location:{lat: -1.22593797237105, lng: 36.72899601349304}, name:"Msamaria Mwema Children Home", cause:"Children", capacity:10, current:0, impactScore:90 },
{ key: "nairobi_children_home", location:{lat: -1.239138325062625, lng: 36.7336275852492}, name:"Nairobi Children’s Home", cause:"Children", capacity:10, current:0, impactScore:95 },
{ key: "new_life_home_trust_lenana", location:{lat: -1.2886887456467833, lng: 36.78782033678651}, name:"New Life Home Trust Lenana Road", cause:"Children", capacity:10, current:0, impactScore:94 },
{ key: "new_life_home_kibera", location:{lat: -1.305678780975741, lng: 36.782262459806425}, name:"New Life Home Kibera", cause:"Community", capacity:10, current:0, impactScore:90 },
{ key: "ngara_health_centre", location:{lat: -1.273074163017246, lng: 36.83150480795122}, name:"Ngara Health Centre", cause:"Health", capacity:10, current:0, impactScore:88 },
{ key: "nyumba_ya_wazee_kasarani", location:{lat:-1.2304624506008681, lng: 36.88736185212755 }, name:"Nyumba ya Wazee Kasarani", cause:"Community", capacity:10, current:0, impactScore:89 },
{ key: "our_lady_of_guadalupe_kamiti", location:{lat: -1.300888203342576, lng: 36.77918826562205}, name:"Our Lady of Guadalupe Parish Adams", cause:"Community", capacity:10, current:0, impactScore:87 },
{ key: "rehema_pefa_home", location:{lat: -1.232884356170069, lng: 36.86738579445699}, name:"Rehema Pefa Home", cause:"Children", capacity:10, current:0, impactScore:90 },
{ key: "st_scholastica_uzima_hospital", location:{lat: -1.2536117733736407, lng: 36.85664315212764}, name:"St. Scholastica Uzima Hospital", cause:"Health", capacity:10, current:0, impactScore:91 },
